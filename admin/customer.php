				...
				<div class="box-body table-responsive">
					<table id="example1" class="table table-bordered table-hover table-striped">
						<thead>
							<tr>
								<th width="10">#</th>
								<th width="180">Nume</th>
								<th width="150">Email </th>
								<th width="180">Tara, Oras, Judet</th>
								<th>Status</th>
								<th width="100">Schimba statusul</th>
								<th width="100">Actiuni</th>
							</tr>
						</thead>
						<tbody>
							<?php
							...
							foreach ($result as $row) {
								...
								<tr class="<?php if($row['cust_status']==1) {echo 'bg-g';}else {echo 'bg-r';} ?>">
									...
									<td>
										<a href="customer-change-status.php?id=<?php echo $row['cust_id']; ?>" class="btn btn-success btn-xs">Schimba statusul</a>
									</td>
									<td>
										<a href="#" class="btn btn-danger btn-xs" data-href="customer-delete.php?id=<?php echo $row['cust_id']; ?>" data-toggle="modal" data-target="#confirm-delete">Sterge</a>
									</td>
								</tr>
								<?php
							}
