...
<section class="content-header">
	<div class="content-header-left">
		<h1>Editeaza Categorie Finala</h1>
	</div>
	<div class="content-header-right">
		<a href="end-category.php" class="btn btn-primary btn-sm">Vezi tot</a>
	</div>
</section>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <button type="submit" class="btn btn-success pull-left" name="form1">SALEVEAZA</button>
                    </div>
                </div>
