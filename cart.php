...
if(isset($_POST['form1'])) {
	...
	<?php else: ?>
		<script>alert('Cosul a fost actualizat cu succes!');</script>
	<?php endif; ?>
    <?php
		...
		<div class="row">
			<div class="col-md-12">
                ...
                <?php if(!isset($_SESSION['cart_p_id'])): ?>
                    <?php echo '<h2 class="text-center">Cosul de cumparaturi este gol</h2></br>'; ?>
                    <?php echo '<h4 class="text-center">Adauga produsele tale favorite in cos</h4>'; ?>
                <?php else: ?>
