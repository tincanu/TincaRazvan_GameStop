		                ...
		                <?php if($checkout_access == 0): ?>
		                	<div class="col-md-12">
				                <div style="color:red;font-size:22px;margin-bottom:50px;">
			                        Trebuie sa completati datele de livrare si facturare. Mergeti la acest  <a href="customer-billing-shipping-update.php" style="color:red;text-decoration:underline;">link</a>.
			                    </div>
	                    	</div>
	                	<?php else: ?>
		                	<div class="col-md-4">
